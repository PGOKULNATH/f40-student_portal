  ...
  return (
    <Fragment>
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 col-md-8 offset-md-2">
            <Alerts />
            <form onSubmit={onSubmit} className="p-2 shadow">
              <div className="form-group row">
                <label
                  htmlFor="username"
                  className="col-form-label col-12 col-md-2 h6"
                >
                  UserName{" "}
                </label>
        ...
        <center>
          <p
            className="m-2 text-primary btn"
            onClick={() => toggleUserModal(!isUserModalOpen)}
          >
            Forget Password
          </p>
        </center>
      ...
      <Modal
        ...
        toggle={() => toggleUserModal(!isUserModalOpen)}
      >
        <ModalHeader toggle={() => toggleUserModal(!isUserModalOpen)}>
          Forget Password
        </ModalHeader>
        <ModalBody>
